...
mgmt.list = as.list(mgmt_areas$name)
...
selectizeInput(inputId = 'mgmt'
               , label = 'Management Areas (Simplified)' 
               , choices = mgmt.list
               , width = 'auto'
               , multiple = T
               , options=list(placeholder = "i.e. EPMT: Lake Mead"
...
Here is where users will eventually find a directory of downloadable map files based on preferred formats/use cases.
```{r}
```
